...
import { Images, argonTheme as nowTheme } from '../constants';
...
const Articles = () => {
  return (
    <Block style={{
      ...
      <Block flex={0.6} >
        <ImageBackground
          source={Images.ProfileBackground2}
        ...
        >
          <Block flex style={styles.profileCard}>
            <Block style={{ position: 'absolute', width: width, zIndex: 5, paddingHorizontal: 20 }}>
              <Block middle style={{ top: height * 0.15 }}>
                  <Avatar
                    ...
                    rounded
                    title= "TB"
                    overlayContainerStyle={{backgroundColor: nowTheme.COLORS.BARBERBLUE}}
            ...
            <Block
              middle
              row
              style={{ position: 'absolute', width: width, top: height * 0.55 - 26, zIndex: 99 }}
            >
      ...
      <Block />
      <Block flex={0.3} style={{ padding: theme.SIZES.BASE, marginTop: 90}}>
